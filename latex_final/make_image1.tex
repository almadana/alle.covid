...
\draw[->,red] (-6.5,1.1) -- (-6.5,\Vone-\BHone+.4) node[anchor=north west ,black ] [xshift=-.3cm] { \scalebox{.9}{ \scriptsize Social distancing} };

\draw[->,red] (-7.2,1.1) -- (-7.8,\Vone-\BHone+.4) node[anchor=north,black ] {\scalebox{.9}{\scriptsize Contact tracing} };

\draw[->,red] (-8,1.1) -- (-9.3,\Vone-\BHone+.4) node[anchor=north east,black,xshift=.3cm] {¸\scalebox{.9}{\scriptsize Personal behavior} };
...
%   \fill[title2]  (\Hone-\BWone,\Vtwo-\BHone+1) rectangle (\Hone+\BWone,\Vtwo+1.8)
  ...
  \draw[fill=boxcolor,draw=none]  (\Hthree-\BWone,\Vone-\BHone) rectangle (\Hthree+\BWone,\Vone+\BHone)
    node[anchor=north east,pos=1,align=left,font=\tiny] [xshift=-.6cm] {\scalebox{0.6} \bf Simulated SIR Dynamics \\
    \begin{tabular}{l r}
