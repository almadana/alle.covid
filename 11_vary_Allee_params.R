...
for (sim in c(1:nrow(simsDf))) {
  ...
  saveRDS(allSims, "./generated_data/SIR_dynamics_simulation_parameter_exploration2.RDS") 
  saveRDS(allFits, "./generated_data/SIR_dynamics_fit_parameter_exploration2.RDS")
}
