...
plot_slopes$sp <- simFit %>%
  ...
  stat_density_2d(geom="polygon", aes(fill=allee, alpha=..level..), contour=T, bins=20) + 
...
ggsave(plot_slopes, file="./plots/fig2_scatter_condados.png", width=5, height=4, units = "in")
